...
export const translations = {
  en: {
    ...
    bond100: {
      ...
      aboutSources: "Counts pool community submissions with a monthly snapshot of public in-game ranking data. Only a player name and server are shown.",
  ...
  jp: {
    ...
    bond100: {
      ...
      aboutSources: "コミュニティ投稿と、ゲーム内公開ランキングの毎月のスナップショットを統合した件数です。表示されるのはプレイヤー名とサーバーのみです。",
