...
export const translations = {
  en: {
    ...
    bond100: {
      ...
      aboutDelay: "Newly added or refreshed players can take a day or two to appear, the wall is a daily snapshot and arona updates on its own schedule.",
      ...
      removalNote: "Only your in-game name and server are shown. To be removed, open \"Request removal\" for the steps to do it on arona.icu, where the data comes from.",
      ...
      form: {
        ...
        privacyNote: "Friend code is used only to verify your entry and prevent duplicates, and is never published or stored as-is. Contact and proof are seen only by moderators.",
        submittedTitle: "Submitted",
        submittedBody: "Thanks! You'll appear on the Hall after the next sync. This can take a day or two, depending on arona's update schedule.",
        ...
        fallbackBody: "We couldn't submit that right now (today's quota may be reached). You can add yourself directly on arona.icu instead. You'll show up on the next Hall update:",
  ...
  jp: {
    ...
    bond100: {
      ...
      removalNote: "表示されるのはゲーム内名とサーバーのみです。掲載を消すには「削除をリクエスト」を開くと、データ元の arona.icu での手順が表示されます。",
      ...
      form: {
        ...
        submittedBody: "ありがとうございます！次回の同期後に殿堂へ表示されます。arona の更新タイミングによっては1〜2日かかることがあります。",
        removalSubmittedBody: "ありがとうございます！削除リクエストを確認します。",
        error: "現在送信できません。後でもう一度お試しください。",
        fallbackTitle: "arona.icu で直接登録",
        fallbackBody: "今は送信できませんでした（本日の上限に達した可能性があります）。代わりに arona.icu で直接登録できます。次回の更新時に殿堂へ表示されます：",
        fallbackSteps: "サーバーを選び、フレンドコードを入力して、Refresh（更新）ボタンを押してください。",
        tryAgain: "再試行",
      },
      serverRegions: {
        global_na: "Global NA",
