...
const en = {
  ...
  activity: {
    private: 'Private analytics',
    title: 'Activity Manager',
    subtitle: 'Anonymous, bounded product events from Eridu Ops sessions.',
    range: 'Date range',
    refresh: 'Refresh',
    retry: 'Try again',
    loading: 'Loading...',
    unavailable: 'Activity data is unavailable right now.',
    notAvailable: 'None',
    ...
    dailyHint: 'Aggregated events received each day.',
    updated: 'Updated {time}',
    noData: 'No activity was recorded in this period.',
    topActions: 'Top actions',
    topActionsHint: 'Most-used routes and workflows.',
    recentActivity: 'Recent activity',
    recentHint: 'Latest aggregated session batches.',
    event: 'Event',
    route: 'Route',
    detail: 'Detail',
    context: 'Context',
    ...
    features: {
      ...
      student_modal: 'Student details',
      apply_upgrade: 'Apply upgrade',
      bulk_modify: 'Bulk modify',
      bond_update: 'Bond update',
      deck_builder: 'Deck builder',
      equipment_farming: 'Equipment farming',
      bond_planner: 'Bond planner',
      crafting_plan: 'Crafting plan',
      hall_entries: 'Hall entries',
      hall_submission: 'Hall submission',
      hall_export: 'Hall export',
      chibi_room: 'Chibi room',
    },
    actions: {
      opened: 'Opened',
      changed: 'Changed',
  ...
  totalExp: 'Total EXP',
  bondGoal: 'Bond {level}',
  bondGoalProgress: 'Bond {level} progress',
  bondGoalProgressHint:
    'Muted progress starts from the minimum EXP for the current bond level. The brighter segment includes planned EXP toward Bond {level}.',
  ...
  planHistory: {
    title: 'Plan History',
    subtitle: 'The latest {count} committed student-plan edits on this device.',
    unknownStudent: 'Unknown student',
    confirmTitle: 'Restore {name}?',
    confirmBody: 'This returns the listed parts of this student plan to their previous state.',
    changedAreas: 'Changed plan areas',
    inventoryWarning: 'Global inventory quantities will not change.',
    error: 'Plan history is unavailable right now.',
    retry: 'Try again',
    restoring: 'Restoring...',
    restorePrevious: 'Restore previous plan',
    clearHistory: 'Clear history',
    clearConfirmTitle: 'Clear plan history?',
    clearConfirmBody: 'This permanently removes all plan history from this device.',
    clearWarning: 'This cannot be undone.',
    clearing: 'Clearing...',
    emptyTitle: 'No plan history yet',
    emptyBody: 'Committed student edits will appear here.',
    ...
    details: {
      ...
      labeledTransition: '{label}: {before} → {after}',
      labelWithState: '{label} ({state})',
      unknownItem: 'Item #{id}',
...
const jp: TranslationTree = {
  ...
  activity: {
    private: '管理者専用',
    title: 'アクティビティ管理',
    subtitle: 'Eridu Ops セッションから収集した匿名の限定イベントです。',
    range: '期間',
    refresh: '更新',
    retry: '再試行',
    loading: '読み込み中...',
    unavailable: '現在、アクティビティデータを利用できません。',
    notAvailable: 'なし',
    summary: 'アクティビティ概要',
    totalEvents: 'イベント合計',
    sessions: 'セッション',
    ...
    dailyHint: '日ごとに受信したイベントの集計です。',
    updated: '{time} 更新',
    noData: 'この期間に記録されたアクティビティはありません。',
    topActions: '上位アクション',
    topActionsHint: 'よく使われたページと操作です。',
    recentActivity: '最近のアクティビティ',
    recentHint: '最新のセッション集計です。',
    event: 'イベント',
    route: 'ページ',
    detail: '詳細',
    context: 'コンテキスト',
    ...
    events: {
      page_view: 'ページ表示',
      feature_opened: '機能を開いた',
      workflow_completed: '操作完了',
      workflow_failed: '操作失敗',
      setting_changed: '設定変更',
      filter_changed: 'フィルター変更',
      plan_action: '計画操作',
    ...
    features: {
      ...
      bond_update: '絆更新',
      deck_builder: '編成ビルダー',
      equipment_farming: '装備周回',
      bond_planner: '絆プランナー',
      crafting_plan: '製造計画',
      hall_entries: '殿堂登録',
      hall_submission: '殿堂申請',
      hall_export: '殿堂出力',
      chibi_room: 'ちびルーム',
    },
    actions: {
  ...
  totalExp: '総経験値',
  bondGoal: '絆{level}',
  bondGoalProgress: '絆{level}までの進捗',
  bondGoalProgressHint:
    '薄い部分は現在の絆レベルに必要な最低経験値を示します。明るい部分には絆{level}までの計画中の経験値が含まれます。',
  ...
  planHistory: {
    title: 'プラン履歴',
    subtitle: 'この端末で確定した生徒プランの最新{count}件の変更です。',
    unknownStudent: '不明な生徒',
    confirmTitle: '{name}を復元しますか？',
    confirmBody: '表示されたプラン項目をこの変更前の状態に戻します。',
    changedAreas: '変更されたプラン項目',
    inventoryWarning: '全体の所持品数は変更されません。',
    error: '現在、プラン履歴を利用できません。',
    retry: '再試行',
    restoring: '復元中...',
    restorePrevious: '以前のプランを復元',
    clearHistory: '履歴を消去',
    clearConfirmTitle: 'プラン履歴を消去しますか？',
    clearConfirmBody: 'この端末のプラン履歴をすべて完全に削除します。',
    clearWarning: 'この操作は元に戻せません。',
    clearing: '消去中...',
    emptyTitle: 'プラン履歴はまだありません',
    emptyBody: '確定した生徒の変更がここに表示されます。',
...
const kr: TranslationTree = {
  ...
  activity: {
    private: '관리자 전용',
    title: '활동 관리자',
    subtitle: 'Eridu Ops 세션에서 수집한 익명의 제한된 이벤트입니다.',
    range: '기간',
    refresh: '새로고침',
    retry: '다시 시도',
    loading: '불러오는 중...',
    unavailable: '현재 활동 데이터를 불러올 수 없습니다.',
    notAvailable: '없음',
    summary: '활동 요약',
    totalEvents: '전체 이벤트',
    sessions: '세션',
    ...
    failureRate: '실패율',
    dailyActivity: '일별 활동',
    dailyHint: '날짜별로 수신된 이벤트 집계입니다.',
    updated: '{time} 업데이트',
    noData: '이 기간에 기록된 활동이 없습니다.',
    topActions: '주요 활동',
    topActionsHint: '가장 많이 사용된 페이지와 작업입니다.',
    recentActivity: '최근 활동',
    recentHint: '최근 세션별 집계입니다.',
    event: '이벤트',
    route: '페이지',
    detail: '상세',
    context: '컨텍스트',
    ...
    features: {
      ...
      bond_update: '인연 업데이트',
      deck_builder: '덱 빌더',
      equipment_farming: '장비 파밍',
      bond_planner: '인연 플래너',
      crafting_plan: '제작 계획',
      hall_entries: '전당 목록',
      hall_submission: '전당 제출',
      hall_export: '전당 내보내기',
      chibi_room: '치비 룸',
    },
    actions: {
  ...
  totalExp: '총 경험치',
  bondGoal: '인연 {level}',
  bondGoalProgress: '인연 {level} 진행도',
  bondGoalProgressHint:
    '연한 부분은 현재 인연 레벨의 최소 필요 경험치를 나타냅니다. 밝은 부분에는 인연 {level}까지 계획한 경험치가 포함됩니다.',
  ...
  loading: '불러오는 중',
  close: '닫기',
  saveChangesFailed: '변경 사항을 저장하지 못했습니다. 다시 시도해 주세요.',
  update: '업데이트',
  confirm: '확인',
  cancel: '취소',
  apply: '적용',
  ...
  planHistory: {
    title: '플랜 기록',
    subtitle: '이 기기에서 저장한 최근 학생 플랜 편집 {count}건입니다.',
    unknownStudent: '알 수 없는 학생',
    confirmTitle: '{name}의 플랜을 복원할까요?',
    confirmBody: '표시된 플랜 항목을 이 편집 이전 상태로 돌립니다.',
    changedAreas: '변경된 플랜 항목',
    inventoryWarning: '전체 인벤토리 수량은 변경되지 않습니다.',
    error: '현재 플랜 기록을 불러올 수 없습니다.',
    retry: '다시 시도',
    restoring: '복원 중...',
    restorePrevious: '이전 플랜 복원',
    clearHistory: '기록 지우기',
    clearConfirmTitle: '플랜 기록을 지울까요?',
    clearConfirmBody: '이 기기의 모든 플랜 기록을 영구적으로 삭제합니다.',
    clearWarning: '이 작업은 되돌릴 수 없습니다.',
    clearing: '지우는 중...',
    emptyTitle: '아직 플랜 기록이 없습니다',
    emptyBody: '저장된 학생 편집이 여기에 표시됩니다.',
