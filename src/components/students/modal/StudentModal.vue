...
import InfoGear from '@/components/students/modal/info/InfoGear.vue';
import InfoSkills from '@/components/students/modal/info/InfoSkills.vue';
import InfoWeapon from '@/components/students/modal/info/InfoWeapon.vue';
